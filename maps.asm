...
INCLUDE "data/maps/headers/PalletTownHouse1.asm"
INCLUDE "scripts/PalletTownHouse1.asm"
INCLUDE "data/maps/objects/PalletTownHouse1.asm"
PalletTownHouse1_Blocks: INCBIN "maps/PalletTownHouse1.blk"
...
INCLUDE "data/maps/headers/PalletTownSchoolHouse.asm"
