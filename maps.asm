...
INCLUDE "data/maps/headers/PalletTownSmallHouse1.asm"
...
INCLUDE "data/maps/headers/PalletTownSchool.asm"
INCLUDE "scripts/PalletTownSchool.asm"
INCLUDE "data/maps/objects/PalletTownSchool.asm"
PalletTownSchool_Blocks: INCBIN "maps/PalletTownSchool.blk"