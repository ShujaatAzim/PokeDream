...
INCLUDE "data/maps/headers/PalletTownHouses.asm"
INCLUDE "scripts/PalletTownHouses.asm"
INCLUDE "data/maps/objects/PalletTownHouses.asm"
PalletTownHouses_Blocks: INCBIN "maps/PalletTownHouses.blk"