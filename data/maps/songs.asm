MapSongBanks::
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; PALLETTOWN_SMALL_HOUSE_1
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; OAKS_RESEARCH_RANCH
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; PALLET_RANCH_GATE
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; PALLETTOWN_SMALL_HOUSE_2
