...
ViridianForest_Object:
	...
	object_event  3, 18, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER4, OPP_BUG_CATCHER, 3
	...
	; NPCs
	object_event 16, 43, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER1
	object_event 27, 40, SPRITE_YOUNGSTER, WALK, UP_DOWN, TEXT_VIRIDIANFOREST_YOUNGSTER5
	...
	object_event  0, 31, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_POKE_BALL, POKE_BALL
