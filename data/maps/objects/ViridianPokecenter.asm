	...
	const_export VIRIDIANPOKECENTER_OFFICER_JENNY
...
ViridianPokecenter_Object:
	...
	object_event  5,  3, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_VIRIDIANPOKECENTER_COOLTRAINER_M
	object_event 11,  2, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_VIRIDIANPOKECENTER_LINK_RECEPTIONIST
	object_event  6,  5, SPRITE_OFFICER_JENNY, WALK, LEFT_RIGHT, TEXT_VIRIDIANPOKECENTER_OFFICER_JENNY
	object_event  4,  1, SPRITE_CHANSEY, STAY, DOWN, TEXT_VIRIDIANPOKECENTER_CHANSEY
	object_event	8,  1, SPRITE_NURSE_JOY, STAY, DOWN, TEXT_VIRIDIANPOKECENTER_NURSE_JOY
