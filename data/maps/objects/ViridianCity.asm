...
ViridianCity_Object:
	...
	def_warp_events
	warp_event 21, 23, VIRIDIAN_POKECENTER, 1
	warp_event 29, 21, VIRIDIAN_MART, 1
	warp_event 21, 15, VIRIDIAN_SCHOOL_HOUSE, 1
	warp_event 21,  9, VIRIDIAN_NICKNAME_HOUSE, 1
	warp_event 32,  7, VIRIDIAN_GYM, 1

	def_bg_events
	bg_event 17, 21, TEXT_VIRIDIANCITY_SIGN
	bg_event 19,  1, TEXT_VIRIDIANCITY_TRAINER_TIPS1
	bg_event 21, 29, TEXT_VIRIDIANCITY_TRAINER_TIPS2
	bg_event 30, 21, TEXT_VIRIDIANCITY_MART_SIGN
	bg_event 22, 23, TEXT_VIRIDIANCITY_POKECENTER_SIGN
