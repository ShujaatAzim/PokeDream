...
PalletTown_Object:
	...
	warp_event 23,  7, PALLET_TOWN_HOUSES, 1
	warp_event 27, 11, PALLET_TOWN_HOUSES, 3
	...
	def_object_events
	object_event 14,  8, SPRITE_OAK, STAY, UP, TEXT_PALLETTOWN_OAK
	...
	object_event 23, 18, SPRITE_COOLTRAINER_F, STAY, UP, TEXT_PALLETTOWN_WOMAN
