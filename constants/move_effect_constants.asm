...
; MoveEffectPointerTable indexes (see data/moves/effects_pointers.asm)
	...
	const FREEZE_SIDE_EFFECT2        				; $25 unused (Blizzard in JP Red/Green)
	...
	const SPEED_UP2_EFFECT           				; $36 Agility
	const SPCLATK_UP2_EFFECT         				; $37 Growth?
	const SPCLDEF_UP2_EFFECT				 				; $38 Amnesia, maybe another?
	const ACCURACY_UP2_EFFECT        				; $39 
	const EVASION_UP2_EFFECT         				; $3A Double Team?
	const HEAL_EFFECT                				; $3B Recover, Softboiled, Rest
	const TRANSFORM_EFFECT           				; $3C
	const ATTACK_DOWN2_EFFECT        				; $3D Charm, if implemented
	const DEFENSE_DOWN2_EFFECT       				; $3E Screech
	...
	const ACCURACY_DOWN_SIDE_EFFECT_ALWAYS  ; $4D
	const_skip                       				; $4E
	const_skip                       				; $4F
	const_skip                       				; $50
