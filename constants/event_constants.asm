...
; Pallet Town events
	...
	const EVENT_PALLET_KEYS_QUEST_STARTED
	const EVENT_PALLET_KEYS_FOUND
	const EVENT_PALLET_KEYS_RETURNED
	const_skip 14
...
; Route 1 Cave events
	...
	const EVENT_BEAT_ROUTE_1_CAVE_TRAINER_1
	const EVENT_BEAT_ROUTE_1_CAVE_TRAINER_2
...
; Route 3 events
	const_next $3E0
	const EVENT_MET_SEYMOUR
	const EVENT_GOT_CLEFAIRY_SEEN_REWARD
